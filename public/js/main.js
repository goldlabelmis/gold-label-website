// Google Apps Script Web App Endpoint for Google Sheet Storage
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 1. Fetch and Display Product Catalog
    fetch('/api/products')
    ...
    // 2. Handle Job Application Form Submission to Google Sheet
